 ...
 */ !(function () {
  ...
  function f() {
    function e(e) {
      function i() {
        return (g.buffer != _ && v(g.buffer), $);
      }
      function l() {
        return (g.buffer != _ && v(g.buffer), ee);
      }
      function h() {
        return (g.buffer != _ && v(g.buffer), te);
      }
      function P() {
        return (g.buffer != _ && v(g.buffer), ne);
      }
      ((e = e || {}),
        ((c = c || (void 0 !== e ? e : {})).ready = new Promise(function (
          e,
          t,
        ) {
          ((F = e), (W = t));
      ...
      if (u) {
        ((a = o ? require("path").dirname(a) + "/" : __dirname + "/"),
          (U = () => {
            B || ((n = require("fs")), (B = require("path")));
          }),
          (L = function (e, t) {
            return (
              U(),
              (e = B.normalize(e)),
              n.readFileSync(e, t ? void 0 : "utf8")
            );
          }),
          (t = (e) => (e = (e = L(e, !0)).buffer ? e : new Uint8Array(e))),
          ...
          (r = (e, t) => {
            ...
            (t instanceof q || m("exiting due to exception: " + t),
              process.exit(e));
          }),
          (c.inspect = function () {
      ...
      var _,
        ...
        te,
        ne,
        re = "undefined" != typeof TextDecoder ? new Z("utf8") : void 0;
      function ae(e, t, n) {
        var r = t + n;
        for (n = t; e[n] && !(r <= n); ) ++n;
      ...
      if (
        ("undefined" != typeof TextDecoder && new Z("utf-16le"),
        d && (_ = c.buffer),
        (p = c.INITIAL_MEMORY || 134217728),
        d)
      )
        ((g = c.wasmMemory), (_ = c.buffer));
      else if (c.wasmMemory) g = c.wasmMemory;
      else if (
        !(
          (g = new WebAssembly.Memory({
            initial: p / 65536,
            maximum: 32768,
            shared: !0,
      ...
      function ge() {
        var e = S;
        try {
          if (e == S && f) return new Uint8Array(f);
          if (t) return t(e);
      ...
      function k(e) {
        for (; 0 < e.length; ) {
          ...
          "function" == typeof n
            ? n(c)
            : "number" == typeof (t = n.Xa)
              ? void 0 === n.ia
                ? be(t)()
                : be(t)(n.ia)
              : t(void 0 === n.ia ? null : n.ia);
        }
      }
      function ye(e) {
        var t = ft();
      ...
      var E = {
        ...
        $a: function () {},
        Ha: function () {
          ((E.receiveObjectTransfer = E.Ka),
            (E.threadInit = E.Aa),
            (E.setExitStatus = E.Ma),
            (X = !1));
        },
        ea: {},
        Ma: function () {},
        ua: function () {
          for (var e in E.ea) {
            var t = E.ea[e];
            t && t.worker && E.za(t.worker);
          }
          for (e = 0; e < E.fa.length; ++e) E.fa[e].terminate();
          E.fa = [];
        },
        za: function (e) {
          E.La(function () {
        ...
        Ka: function () {},
        Aa: function () {
          for (var e in E.pa) E.pa.hasOwnProperty(e) && E.pa[e]();
        },
        Ia: function (r, a) {
          ((r.onmessage = (e) => {
            var t,
              n = (e = e.data).cmd;
            (r.ga && (E.Ca = r.ga.va),
              e.targetThread && e.targetThread != st()
                ? (t = E.ea[e.fb])
                    ...
                    : "cleanupThread" === n
                      ...
                      : "killThread" === n
                        ? ((e = e.thread),
                          ...
                          n.worker.terminate(),
                          it(e),
                          E.ka.splice(E.ka.indexOf(n.worker), 1),
                          (n.worker.ga = void 0))
                        : "cancelThread" === n
                          ? E.ea[e.thread].worker.postMessage({ cmd: "cancel" })
                          : "loaded" === n
                            ? ((r.loaded = !0),
                              a && a(r),
                              r.ja && (r.ja(), delete r.ja))
                            : "print" === n
                              ? Q("Thread " + e.threadId + ": " + e.text)
                              : "printErr" === n
                                ? m("Thread " + e.threadId + ": " + e.text)
                                : "alert" === n
                                  ? alert(
                                      "Thread " + e.threadId + ": " + e.text,
                                    )
                                  : "setimmediate" === e.target
                                    ...
                                    : "onAbort" === n
                                      ...
                                      : m(
                                          "worker sent an unknown command " + n,
                                        ),
              (E.Ca = void 0));
          }),
            (r.onerror = (e) => {
            ...
            r.postMessage({
              cmd: "load",
              urlOrBlob: c.mainScriptUrlOrBlob || gt,
              wasmMemory: g,
              wasmModule: J,
            }));
        },
        Ba: function () {
          ...
          E.fa.push(new Worker(e));
        },
        Ea: function () {
          return (0 == E.fa.length && (E.Ba(), E.Ia(E.fa[0])), E.fa.pop());
        },
      };
      function ve(e) {
        if (d) return O(1, 0, e);
      ...
      function be(e) {
        var t = D[e];
        return (
          t || (e >= D.length && (D.length = e + 1), (D[e] = t = ue.get(e))),
          t
        );
      }
      function Se(e) {
        ...
        if (!t) return 6;
        E.ka.push(t);
        var n = (E.ea[e.ta] = { worker: t, va: e.ta }),
          r =
            ((t.ga = n),
            {
              cmd: "run",
              start_routine: e.Na,
              arg: e.ia,
              threadInfoStruct: e.ta,
            });
        return (
          (t.ja = () => {
            ((r.time = performance.now()), t.postMessage(r, e.Sa));
          }),
          t.loaded && (t.ja(), delete t.ja),
          0
        );
      }
      ...
      var xe = u
        ...
        Ae = {};
      function ke(e, t, n) {
        return d ? O(2, 1, e, t, n) : 0;
      }
      function Ee(e, t) {
        if (d) return O(3, 1, e, t);
      }
      function De(e, t, n) {
        return d ? O(4, 1, e, t, n) : 0;
      }
      function Ie(e, t, n) {
        if (d) return O(5, 1, e, t, n);
      }
      var I = [];
      function O(a, o) {
                ...
                ? ((s = h()[(s.oa + 8) >> 2]),
                  ...
                  ye(function () {
                    var e,
                      ...
                      n = 0;
                    (a &&
                      ((n = oe(a) + 1), (e = ut(n)), w(a, l(), e, n), (n = e)),
                      (h()[t >> 2] = n),
                      (h()[(t + 4) >> 2] = o),
                      (h()[(t + 8) >> 2] = i),
                      ot(r, 657457152, 0, n, t));
                  }),
                  1)
                : -4
              : ((e = !1),
                (s = s.ya ? s.ya : s).na &&
                  s.na.ma &&
                  (e =
                    0 === (e = s.na.ma.getParameter(2978))[0] &&
                    0 === e[1] &&
                    e[2] === s.width &&
                    e[3] === s.height),
                (s.width = t),
                (s.height = n),
                e && s.na.ma.viewport(0, 0, t, n),
                0))
          : -4;
      }
      function je(e, t, n) {
        return d ? O(6, 1, e, t, n) : Ce(e, t, n);
      }
      function qe(n, e) {
        n.wa ||
          ((n.wa = n.getContext),
          (n.getContext = function (e, t) {
            return ("webgl" == e) ==
              (t = n.wa(e, t)) instanceof WebGLRenderingContext
              ? t
              : null;
          }));
        var t,
          ...
          o = n.getContext("webgl", e);
        {
          if (o) {
            if (
              ...
              (r = ut(8)),
              (h()[(r + 4) >> 2] = st()),
              (a = { Za: r, attributes: e, version: e.Ja, ma: o }),
              o.canvas && (o.canvas.na = a),
              (void 0 === e.xa || e.xa) && !(o = (o = a) || Pe).Ga)
            ) {
              o.Ga = !0;
              var i = (t = o.ma),
              ...
              (l &&
                ...
                (t.Va = t.getExtension("EXT_disjoint_timer_query")),
                (t.bb = t.getExtension("WEBGL_multi_draw")),
      ...
      function Be() {
        if (!Fe) {
          ...
          for (e in Le) void 0 === Le[e] ? delete t[e] : (t[e] = Le[e]);
          var n = [];
        ...
        return d
          ...
          : ((o = 0),
            Be().forEach(function (e, t) {
              var n = a + o;
              for (t = h()[(r + 4 * t) >> 2] = n, n = 0; n < e.length; ++n)
      ...
      function Ne(e, t, n, r) {
        return d
          ? O(10, 1, e, t, n, r)
          : ((e = Ae.Ya(e)), (t = Ae.Wa(e, t, n)), (h()[r >> 2] = t), 0);
      }
      function Ve(e, t, n, r, a) {
        if (d) return O(11, 1, e, t, n, r, a);
      }
      function Ge(e, t, n, r) {
        if (d) return O(12, 1, e, t, n, r);
      ...
      function Xe(e, t, n, r) {
        ...
        function u(e) {
          e = Qe(new Date(e.da + 1900, 0, 1), e.sa);
        ...
        var l,
          ...
          f = {
            "%a": function (e) {
              return p[e.ra].substring(0, 3);
            },
            "%A": function (e) {
              return p[e.ra];
            },
            "%b": function (e) {
              return m[e.ha].substring(0, 3);
            },
            "%B": function (e) {
              return m[e.ha];
            },
            "%C": function (e) {
              return o(((e.da + 1900) / 100) | 0, 2);
            },
            "%d": function (e) {
              return o(e.la, 2);
            },
            ...
            "%I": function (e) {
              return (
                0 == (e = e.qa) ? (e = 12) : 12 < e && (e -= 12),
                o(e, 2)
              );
            },
            "%j": function (e) {
              return o(e.la + ze(R(e.da + 1900) ? T : C, e.ha - 1), 3);
            },
            "%m": function (e) {
              return o(e.ha + 1, 2);
            },
            ...
            "%U": function (e) {
              var t = new Date(e.da + 1900, 0, 1),
                n = 0 === t.getDay() ? t : Qe(t, 7 - t.getDay());
              return i(n, (e = new Date(e.da + 1900, e.ha, e.la))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        (ze(R(e.getFullYear()) ? T : C, e.getMonth() - 1) -
                          31) +
                        e.getDate()) /
                        7,
                    ),
            ...
            "%V": function (e) {
              var t = new Date(e.da + 1901, 0, 4),
                n = s(new Date(e.da + 1900, 0, 4)),
                t = s(t),
                r = Qe(new Date(e.da + 1900, 0, 1), e.sa);
              return i(r, n) < 0
                ? "53"
                : i(t, r) <= 0
                  ? "01"
            ...
            "%W": function (e) {
              var t = new Date(e.da, 0, 1),
                n =
                  1 === t.getDay()
                    ? t
                    : Qe(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
              return i(n, (e = new Date(e.da + 1900, e.ha, e.la))) < 0
                ? o(
                    Math.ceil(
                      (31 -
            ...
            "%y": function (e) {
              return (e.da + 1900).toString().substring(2);
            },
            "%Y": function (e) {
              return e.da + 1900;
            },
      ...
      E.Fa();
      var Je,
        Ke = [null, ve, ke, Ee, De, Ie, je, Ue, Ye, He, Ne, Ve, Ge],
        Ze = {
          p: function (e, t) {
            $e(e, t);
          },
          ...
          e: function (e, t, n, r) {
            ...
            return "undefined" == typeof SharedArrayBuffer
              ...
              : ((a = []),
                d && 0 === a.length
                  ? nt(687865856, e, t, n, r)
                  : ((e = { Na: n, ta: e, ia: r, Sa: a }),
                    d
                      ? ((e.Ta = "spawnThread"), postMessage(e, a), 0)
                      : Se(e)));
          },
          g: ke,
          o: Ee,
          ...
          w: function (e, t, n) {
            var r;
            for (I.length = 0, n >>= 2; (r = l()[t++]); )
              ((r = r < 105) && 1 & n && n++,
                I.push(r ? P()[n++ >> 1] : h()[n]),
                ++n);
            return d
              ? O.apply(null, [-1 - e, 0].concat(I))
              : _e[e].apply(null, I);
          },
          h: function () {
            u ||
          ...
          D: function (e, t, n) {
            ((Oe.length = t), (n >>= 3));
            for (var r = 0; r < t; r++) Oe[r] = P()[n + r];
            return (e < 0 ? _e[-e - 1] : Ke[e]).apply(null, Oe);
          },
          A: function (e) {
            var t = l().length;
            if (!((e >>>= 0) <= t || 2147483648 < e))
              for (var n = 1; n <= 4; n *= 2) {
                ...
                e: {
                  try {
                    (g.grow((a - _.byteLength + 65535) >>> 16), v(g.buffer));
                    var o = 1;
                    break e;
                  } catch (e) {}
                  o = void 0;
        ...
        $e =
          (!(function () {
            function t(e, t) {
              ((c.asm = e.exports),
                ...
                d ||
                  (x--,
                  c.monitorRunDependencies && c.monitorRunDependencies(x),
                  0 == x &&
                    (null !== me && (clearInterval(me), (me = null)), M) &&
                    ((e = M), (M = null), e())));
            }
            function n(e) {
            ...
            if (
              (d ||
                (x++, c.monitorRunDependencies && c.monitorRunDependencies(x)),
              c.instantiateWasm)
            )
              try {
          ...
          (c._main = function () {
            return ($e = c._main = c.asm.G).apply(null, arguments);
          })),
        et =
          ((c._command = function () {
            return (c._command = c.asm.H).apply(null, arguments);
          }),
          (c._isReady = function () {
            return (c._isReady = c.asm.I).apply(null, arguments);
          }),
          (c._isSearching = function () {
            return (c._isSearching = c.asm.J).apply(null, arguments);
          }),
          (c._free = function () {
            return (c._free = c.asm.K).apply(null, arguments);
          }),
          (c._emscripten_tls_init = function () {
            return (c._emscripten_tls_init = c.asm.L).apply(null, arguments);
          }),
          (c.___errno_location = function () {
            return (et = c.___errno_location = c.asm.M).apply(null, arguments);
          })),
        tt =
          ((c.__emscripten_thread_crashed = function () {
            return (c.__emscripten_thread_crashed = c.asm.N).apply(
              null,
              arguments,
            );
          }),
          (c._emscripten_proxy_main = function () {
            return (c._emscripten_proxy_main = c.asm.O).apply(null, arguments);
          }),
          (c.__emscripten_thread_init = function () {
            return (tt = c.__emscripten_thread_init = c.asm.P).apply(
              null,
              arguments,
            );
          })),
        nt =
          ((c._emscripten_current_thread_process_queued_calls = function () {
            return (c._emscripten_current_thread_process_queued_calls =
              c.asm.Q).apply(null, arguments);
          }),
          (c._emscripten_sync_run_in_main_thread_4 = function () {
            return (nt = c._emscripten_sync_run_in_main_thread_4 =
              c.asm.R).apply(null, arguments);
          })),
        rt = (c._emscripten_main_thread_process_queued_calls = function () {
          return (rt = c._emscripten_main_thread_process_queued_calls =
            c.asm.S).apply(null, arguments);
        }),
        at = (c._emscripten_run_in_main_runtime_thread_js = function () {
          return (at = c._emscripten_run_in_main_runtime_thread_js =
            c.asm.T).apply(null, arguments);
        }),
        ot = (c._emscripten_dispatch_to_thread_ = function () {
          return (ot = c._emscripten_dispatch_to_thread_ = c.asm.U).apply(
            null,
            arguments,
          );
        }),
        it = (c.__emscripten_thread_free_data = function () {
          return (it = c.__emscripten_thread_free_data = c.asm.V).apply(
            null,
            arguments,
          );
        }),
        st =
          ((c.__emscripten_thread_exit = function () {
            return (c.__emscripten_thread_exit = c.asm.W).apply(
              null,
              arguments,
            );
          }),
          (c._pthread_self = function () {
            return (st = c._pthread_self = c.asm.X).apply(null, arguments);
          })),
        ut = (c._malloc = function () {
          return (ut = c._malloc = c.asm.Y).apply(null, arguments);
        }),
        ct = (c._emscripten_stack_set_limits = function () {
          return (ct = c._emscripten_stack_set_limits = c.asm._).apply(
            null,
            arguments,
          );
        }),
        ...
        lt = (c.stackRestore = function () {
          return (lt = c.stackRestore = c.asm.aa).apply(null, arguments);
        }),
        j = (c.stackAlloc = function () {
          return (j = c.stackAlloc = c.asm.ba).apply(null, arguments);
        }),
        dt = (c.__emscripten_allow_main_runtime_queued_calls = 6672416);
      function q(e) {
      ...
      function mt(e) {
        ...
        (b() || d || E.ua(),
          b() || (E.ua(), c.onExit && c.onExit(e), (K = !0)),
          r(e, new q(e)));
      }
      if (
        ((c.ccall = function (e, t, n, r) {
          ...
          if (r)
            for (var s = 0; s < r.length; s++) {
              var u = a[n[s]];
              u ? (0 === i && (i = ft()), (o[s] = u(r[s]))) : (o[s] = r[s]);
            }
          return (
            (n = e.apply(null, o)),
            (e = n),
            0 !== i && lt(i),
            "string" === t ? y(e) : "boolean" === t ? !!e : e
          );
        }),
        ...
        for (
          ...
          c.preInit.pop()();
      var ht = !0;
      return (c.noInitialRun && (ht = !1), pt(), e.ready);
    }
    var gt;
    ((gt =
      "undefined" != typeof document && document.currentScript
        ...
        : void 0),
      "undefined" != typeof __filename && (gt = gt || __filename));
    return (
  ...
  function o() {
    for (; t.length && (!r._isSearching || !r._isSearching()); ) n(t.shift());
  }
  function l(e) {
  ...
  function d() {
    if (r._isReady && !r._isReady()) return setTimeout(d, 10);
    var n;
    ("undefined" == typeof IS_ASYNCIFY
      ...
      a.length &&
        ((n = 0),
        (function e() {
          for (var t; n < a.length; ) {
            if ((t = a[n++]).startsWith("sleep "))
              return setTimeout(e, t.slice(6));
            l(t);
          }
        })()));
  }
            ...
            (++r,
              ...
              r === n &&
                ((e = URL.createObjectURL(
                  new Blob(a, { type: "application/wasm" }),
                )),
                u(e)));
          };
        })(e),
              ...
              if ("load" === e.data.cmd)
                ((r.wasmModule = e.data.wasmModule),
                  ...
                  "string" == typeof e.data.urlOrBlob
                    ...
                    : ((t = URL.createObjectURL(e.data.urlOrBlob)),
                      importScripts(t),
                ...
                ((r.__performance_now_clock_drift =
                ...
                try {
                  ...
                  r.keepRuntimeAlive()
                    ? r.PThread.setExitStatus(n)
                    : r.__emscripten_thread_exit(n);
                } catch (e) {
                  if ("unwind" != e) {
                    if (!(e instanceof r.ExitStatus)) throw e;
                    r.keepRuntimeAlive() ||
                      r.__emscripten_thread_exit(e.status);
                  }
                }
              } else
                "cancel" === e.data.cmd
                  ...
                  : "setimmediate" !== e.data.target &&
                    ("processThreadQueue" === e.data.cmd
                      ? r._pthread_self() &&
                        r._emscripten_current_thread_process_queued_calls()
                      : "processProxyingQueue" === e.data.cmd
                        ? r._pthread_self() &&
                          r._emscripten_proxy_execute_queue(e.data.queue)
                        : (o(
                            "worker.js received unknown command " + e.data.cmd,
                          ),
                          o(e.data)));
            } catch (e) {
              throw (
          ...
          (self.onmessage = function (e) {
            "load" === e.data.cmd
              ? ((r.wasmModule = e.data.wasmModule),
                ...
                e.data.wasmOffsetConverter &&
                  (r.wasmOffsetData = e.data.wasmOffsetConverter),
        ...
        e
          ? require.main === module
            ? ((c = require("path")),
              (s = c.join(
                __dirname,
                c.basename(__filename, c.extname(__filename)) + ".wasm",
              )),
              (r = {
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e &&
                    (r.processCommand ? r.processCommand(e) : a.push(e),
                    "quit" === e) &&
                    process.exit();
                })
                .on("close", function () {
          ...
          : ((e = self.location.hash.substr(1).split(",")),
            ...
            (onmessage =
              ...
              function (e) {
                if (
                  (r.processCommand ? r.processCommand(e.data) : a.push(e.data),
                  "quit" === e.data)
                )
                  try {
                    self.close();
